...
const buildScript = path.join(backendRoot, 'scripts', 'build_oss_tools.py');
...
console.error('Failed to bundle ossutil. Set GYMCLIP_PYTHON if your Python command is non-standard.');
process.exit(1);
